	...
	public class ActionBarLocalizer: MonoBehaviour
	{
		...
		public void ApplyLocalization(LocalizationData localization)
		{
			...
			for(int i = 0; i < length; i++)
			{
				...
				{
					case LocalizationKey.COPY: actionBar.UpdateCopyLabel(localizedString.value); break;
					case LocalizationKey.CUT: actionBar.UpdateCutLabel(localizedString.value); break;
					case LocalizationKey.PASTE: actionBar.UpdatePasteLabel(localizedString.value); break;
					case LocalizationKey.SELECT_ALL: actionBar.UpdateSelectAllLabel(localizedString.value); break;
				}
			}
		}
	}
