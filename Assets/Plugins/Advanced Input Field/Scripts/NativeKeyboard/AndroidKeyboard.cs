...
namespace AdvancedInputFieldPlugin
{
	...
	public class AndroidKeyboard: NativeKeyboard
	{
		...
		{
			mainClass.CallStatic("showKeyboard", text, (int)keyboardType, (int)characterValidation, (int)lineType, (int)autocapitalizationType, autocorrection, secure, emojisAllowed, hasNext, characterLimit, characterValidatorJSON);
		}
