...
namespace AdvancedInputFieldPlugin
{
	...
	public class IOSKeyboard: NativeKeyboard
	{
		...
		[DllImport("__Internal")]
		private static extern void _nativeKeyboard_showKeyboard(string text, int keyboardType, int characterValidation, int lineType, int autocapitalizationType, bool autocorrection, bool secure, bool emojisAllowed, bool hasNext, int characterLimit, string characterValidatorJSON);
		[DllImport("__Internal")]
		...
		{
			_nativeKeyboard_showKeyboard(text, (int)keyboardType, (int)characterValidation, (int)lineType, (int)autocapitalizationType, autocorrection, secure, emojisAllowed, hasNext, characterLimit, characterValidatorJSON);
		}
