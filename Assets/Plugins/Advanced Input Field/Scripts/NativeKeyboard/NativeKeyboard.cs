...
namespace AdvancedInputFieldPlugin
{
	...
	public abstract class NativeKeyboard: MonoBehaviour
	{
		...
		public virtual void ShowKeyboard(string text, KeyboardType keyboardType, CharacterValidation characterValidation, LineType lineType, AutocapitalizationType autocapitalizationType, bool autocorrection, bool secure, bool emojisAllowed, bool hasNext, int characterLimit, string characterValidatorJSON) { }
